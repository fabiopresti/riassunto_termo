...
\begin{figure}[h!]
	...
	\caption{Grafico $\theta$ su $Q$ per l'$H_2 O$. Le regioni a temperatura costante sono quelle in cui avviene il cambio di fase.}
...
\end{align*}
Durante il passaggio di fase la pressione rimane costante (come visto nella correzione di Maxwell dei grafici di Van der Waals) dunque varierà solo il volume. Come visto, il lavoro a pressione costante del passaggio di fase sarà
\begin{align*}
	&L_{l-v} = p(v_v-v_l)\\
	&L_{s-l} = p(v_l-v_s)
\end{align*}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{../images/calorimetro_bunsen}
