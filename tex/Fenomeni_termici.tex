...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Van_der_Waals}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{gausspdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{guscio}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{speedpdf}
...
\begin{enumerate}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.4\linewidth]{trasformazione-isocora}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.4\linewidth]{trasformazione-isobara}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.5\linewidth]{trasformazione-isoterma}
...
\FloatBarrier
	...
	\begin{align*}
	&L = \int_{v_i}^{v_f} p(v)dv =\int_{v_i}^{v_f} \frac{R\theta}{v-b}-\frac{a}{v^2} dv = R\theta\int_{v_i}^{v_f} \frac{dv}{v-b}  - a\int_{v_i}^{V_f}\frac{dv}{v^2} dv =\\
	&R\theta \ln\left(\frac{v_f-b}{v_i-b}\right) + a\left(\frac{1}{v_f}-\frac{1}{v_i}\right)
	\end{align*}
	Si noti che questa espressione differisce da quella dei gas perfetti per il secondo termine, negativo, e per la sottrazione del covolume al primo termine. Il secondo termine riduce il lavoro compiuto, ciò è dovuto alle interazioni intermolecolari. Anche la sottrazione del covolume riduce il lavoro. Ne segue che il lavoro di espansione di un gas reale è sempre minore di quello di un gas perfetto.
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.5\linewidth]{espansione_libera}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.5 \linewidth]{ciclo}
