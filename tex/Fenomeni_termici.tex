...
\end{align*}
I gradi di libertà si calcolano, come visto nel capitolo di meccanica, considerando 3 d.o.f. per ogni particella e sottraendo i legami linearmente indipendenti che si instaurano. Nel caso di una molecola biatomica abbiamo $\nu = 3+3-1 = 5$. In questo caso i due gradi di libertà in più sono dovuti all'energia di vibrazione (possiamo vedere il legame come una molla che si comprime ed estende) e uno dovuto alla rotazione tridimensionale della molecola, in molecole poliatomiche i gradi di libertà dipenderanno dalla forma caratteristica (ad esempio \(H_2 O\) con forma a V avrà diversi d.o.f. della \(CO_2\) lineare).\\
...
Nell'ambito della fisica classica non si riesce a spiegare perché c diminuisca dopo una temperatura di soglie e perchè lo faccia quadraticamente; questo fu un grande limite della fisica classica che venne poi risolto dalla fisica quantistica.
\appendix
